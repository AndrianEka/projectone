...
@section('nav')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-white active" aria-current="page">Pemasok</li>
        </ol>
        <h6 class="font-weight-bolder text-white mb-0">Pemasok</h6>
    </nav>
@endsection
@section('content')
            ...
            <div class="col-12">
                <div class="card mb-4">
                    <div class="card-header pb-0">
                        <h6 class="text-center">Data pemasok</h6>
                        <a href="/pemasok/create" class="btn btn-primary">Add</a>
                    </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex flex-column justify-content-center">
                                                <h6 class="mb-0 text-md text-center">{{ $p->nama_pemasok }}</h6>
                                            </div>
                                        </td>
                                        ...
                                        <td class="align-middle ">
                                            <a href="/pemasok/{{ $p->id }}/edit"
                                                class="mb-0 text-sm  btn btn-warning">
                                                Edit
                                            </a>
                                            <form action="/pemasok/{{ $p->id }}" method="POST">
                                                @method('DELETE')
                                                @csrf
